    ...
    <div className="relative flex items-center" ref={dropdownRef}>
      ...
      >
        <span className="text-[12px] font-bold text-gray-700 dark:text-gray-300 flex items-center gap-1">
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-700 dark:text-gray-300">
      ...
      {isOpen && (
        <div className="absolute bottom-full mb-2 left-0 w-64 bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 shadow-xl shadow-gray-200/50 dark:shadow-none rounded-xl py-3 px-4 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
          <div className="text-[11px] font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 border-b border-gray-50 dark:border-slate-800 pb-2 mb-3">
            {t('settings.configTitle', 'Cấu hình LLM & Tìm kiếm')}
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700 accent-gray-800 dark:accent-gray-300 transition-colors"
              />
              <p className="text-[10px] text-gray-400">{t('settings.tempDesc', 'Điều chỉnh độ sáng tạo của câu trả lời.')}</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700 accent-gray-800 dark:accent-gray-300 transition-colors"
              />
              <p className="text-[10px] text-gray-400">{t('settings.maxTokensDesc', 'Giới hạn độ dài tối đa (số từ) của câu trả lời.')}</p>
            </div>
          ...
          <div className="mt-4 pt-3 border-t border-gray-100 dark:border-slate-800">
            <Link
              ...
              className="text-[11px] font-semibold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-colors"
            >
              {t('settings.openFullConfig', 'Mở cấu hình đầy đủ →')}
            </Link>
          </div>
        </div>
      )}
