...
export const DEFAULT_AI_SETTINGS: AISettings = {
  ...
  providerCredentials: {
    ...
    groq: { apiKey: '', remember: true },
    openai: { apiKey: '', remember: true },
  },
  roles: {
    answer: { ...DEFAULT_ROLE },
...
function splitCredentialStorage(settings: AISettings) {
  ...
  const groq = settings.providerCredentials.groq ?? { apiKey: '', remember: true };
  const openai = settings.providerCredentials.openai ?? { apiKey: '', remember: true };
  ...
  const localSettings: AISettings = {
    ...
    providerCredentials: {
      ...
      groq: groq.remember ? groq : { ...groq, apiKey: '' },
      openai: openai.remember ? openai : { ...openai, apiKey: '' },
    },
  };
