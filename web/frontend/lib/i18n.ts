...
const vi = {
  translation: {
    ...
    chat: {
      placeholder: "Hỏi về điều luật, quyền, nghĩa vụ hoặc thủ tục pháp lý...",
      ...
      legalSources: "Căn cứ pháp lý",
      noSources: "Không có văn bản pháp lý trích dẫn cho đoạn chat này.",
...
const en = {
  translation: {
    ...
    chat: {
      placeholder: "Ask about laws, rights, obligations or legal procedures...",
      ...
      noSources: "No legal documents cited for this chat.",
